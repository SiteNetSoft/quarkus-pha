...
document.addEventListener('alpine:init', () => {
  ...
  Alpine.data('phaChart', (config = {}) => ({
    _chart: null,
    _resizeHandler: null,

    init() {
      var container = this.$el.querySelector('.pha-c-chart__canvas') || this.$el;
      var theme = config.theme || 'patternfly';
      var renderer = config.renderer || 'canvas';
