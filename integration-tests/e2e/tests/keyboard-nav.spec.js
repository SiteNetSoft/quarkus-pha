...
const COMPONENT_PATHS = [
  ...
  "/components/form-validation", "/components/sortable-table", "/components/click-to-edit", "/components/toast-confirm", "/components/live-search", "/components/login-page", "/components/map",
