...
const LAYOUTS = {
  ...
  flex: [
    ...
    "ordering",
    "ordering-first-last",
    "ordering-first-last-responsive",
    "ordering-responsive",
  ],
  gallery: [
    "basic",
  ...
  grid: [
    ...
    "ordering-responsive",
    "ordering-grouped",
    "ordering-grouped-responsive",
  ],
  level: ["basic", "with-gutter", "three-items"],
  split: ["basic", "with-fill", "with-gutter", "wrappable"],
